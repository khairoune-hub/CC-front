...
function updateUserContext() {
    switch(selectedPlatform) {
        ...
        case 'facebook':
            ...
            break;
        case 'linkedin':
            userContext = "Créez un contenu professionnel adapté à LinkedIn, en mettant l'accent sur la valeur commerciale et les analyses sectorielles. Utilisez un ton formel et un formatage professionnel en françaisun formatage approprié et des appels à l'action convaincants..";
            break;
        case 'email':
            userContext = "Créez un contenu optimisé pour les e-mails avec des lignes d'objet claires, un formatage approprié et des appels à l'action convaincants. Concentrez-vous sur une communication professionnelle en français  Utilisez un ton formel et un formatage professionnel en françaisun formatage approprié et des appels à l'action convaincants.";
            break;
        default:
            userContext = '';
    }
