...
function updateUserContext() {
    switch (selectedPlatform) {
        case 'instagram':
            ...
            break;
        case 'telegram':
            userContext = "أسلوب السرد: استخدم أسلوبًا سرديًا جذابًا لجعل المحتوى مشوقًا.
                    أمثلة واقعية: قم بإدراج أمثلة من الواقع لتوضيح الأفكار.
                    تنظيم النص: قم بتنظيم المحتوى باستخدام العناوين والفقرات ليسهل قراءته.
                    تدرج الأفكار: رتب الأفكار في نصك بشكل هرمي ومترابط.
                    أسلوب المخاطبة: استخدم صيغة المخاطب لإشراك القارئ وإبقائه متفاعلًا.
                    نصائح عملية: قدم نصائح قابلة للتطبيق أو خطوات عملية يمكن للقارئ تنفيذها.
                    استدعاء الإجراء: قم باستخدام صيغة استدعاء الإجراء (Call to Action) لتحفيز القارئ على التفاعل أو اتخاذ الخطوة التالية.
                    التأثير العاطفي: ركز على المشاعر وأبرز الجانب العاطفي لدفع القارئ للتفاعل مع المحتوى.
                    لغة بسيطة: قدم المعلومات بلغة واضحة وبسيطة دون استخدام تعقيد غير ضروري.
                        ";
            contentExamples = [
                {
