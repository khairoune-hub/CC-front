...
function updateUserContext() {
    switch(selectedPlatform) {
        ...
        case 'telegram':
            ...
            break;
        case 'facebook':
            userContext = "قم بإنشاء محتوى مُحسّن لمنصة الفايسبوك مع التركيز على الجاذبية البصرية والتفاعل. يُفضّل استخدام الهاشتاغات المناسبة والحفاظ على العبارات مختصرة لكنها جذابة، مع مزيج بين اللهجة العربية واللهجة الجزائرية.";
            break;
        case 'linkedin':
            ...
            break;
        case 'email':
            userContext ="Créez un contenu professionel sand des emojis optimisé pour les e-mails Utilisez un ton formel et un formatage professionnel en français.";
            break;
        default:
            userContext = '';
    }
